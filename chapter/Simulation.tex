...
\end{equation}
It is difficult to visualize a quaternion, however the most simplistic method of understanding it is shown in Figure \textbf{TODO: Provide figure of quaternion}. A quaternion is consequently a unit vector protruding from the centre point of an object as well as the angle of rotation of that object around that unit vector. As seen in Figure~\ref{fig:Pitch} the angle $\theta$ is the angle of rotation around the $y$-axis, for quaternions the angle of rotation is the same principle, however the axis around which the object is rotating, is the unit vector. Therefore, $q_4$ provides the angle of rotation while, $q_1, q_2, q_3$ represents the unit vector, however with the condition of Eq~\ref{Eq-quaternion dependency}.
...
\textbf{TODO: Show plot of 3D earth orbit...}
...
\textbf{TODO: Show drawing of sun relative to earth and satellite...}

\textbf{TODO: Show graph of sun plot...}
...
\textbf{TODO: Show graph of geomagnetic plot...}
...
\textbf{TODO: Show drawing of aerodynamic disturbance...}
...
\end{equation}
where $U_d = mrd$ is the dynamic imbalance. \textbf{TODO: Get values of Us and Ud used in simulation}
...
\textbf{TODO: Produce graphs for the estimation (Estimation Metric) with the eclipse phases.}
...
\textbf{TODO: Produce graphs for the control (Pointing accuracy) with the eclipse phases.}
...
\textbf{TODO: Show graph of momentum dumping plot (Reaction wheels momentum with and without momentum dumping)...}
