...
\begin{figure}[!htb]
	\centering
	\def\pgfwidth{7cm}
	\import{Figures/TexFigures/Summary/100.0/}{Estimation MetricAnalysisPerfectRecoveryReflection.pgf}
...
\begin{figure}[!htb]
	\centering
	\def\pgfwidth{7cm}
	\import{Figures/TexFigures/Summary/100.0/}{Estimation MetricAnalysisPerfectRecoveryMagnetic.pgf}
