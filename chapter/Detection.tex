...
The analysis of the each method will be done by providing the estimation metric as well as the prediction accuracy by varying the isolation accuracy. This is done to determine the dependency of the detection method on the isolation accuracy. From the previous chapter is is clear that the recovery does not change the effect of the magnetic moment disturbance and therefore the performance of the detection methods are analysed with the sun reflection anomaly.
